...
#define MAX_BLOCK_SIZE_GEN USDE_MAX_BLOCK_SIZE_GEN
#define MAX_BLOCK_SIGOPS USDE_MAX_BLOCK_SIGOPS
#define MAX_ORPHAN_TRANSACTIONS USDE_MAX_ORPHAN_TRANSACTIONS
...
#define LOCKTIME_THRESHOLD USDE_LOCKTIME_THRESHOLD
